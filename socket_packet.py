...
class PacketType(Enum):
    SERVER_HEARTBEAT_TO_BOT = 0
    SERVER_CHAT_TO_BOT = 1
    SERVER_COMMAND_FEEDBACK_TO_BOT = 2
    SERVER_INFORMATION_TO_BOT = 3
    BOT_LIST_REQUEST_TO_SERVER = 4
    BOT_COMMAND_TO_SERVER = 5
    BOT_CHAT_TO_SERVER = 6
